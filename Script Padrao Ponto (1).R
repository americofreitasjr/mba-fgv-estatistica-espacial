...
par(mfrow=c(2,2))
plot(aNYppp, pch=21, cex=0.9, bg="blue", main="Ocorrencias", cex.main=0.5)
...
plot(density.ppp(NYppp, sigma=0.01, kernel="gaussian"), main="Sigma=0.01", cex.main=0.5)#gaussian
plot(density.ppp(NYppp, sigma=0.05, kernel="quartic"), main="Sigma=0.05", cex.main=0.5)#quartic
plot(density.ppp(aNYppp, sigma=0.0151, kernel="gaussian"), main="Sigma=0.0151", cex.main=0.5)
plot(density.ppp(aNYppp, sigma=0.026, kernel ="quartic" ), main="Sigma=0.026", cex.main=0.5)#epanechnikov
par(mfrow=c(1,1))
...
nyhyb = get_googlemap('New York City',zoom=10,maptype='Terrain')
ggmap(nyhyb)
...
Gest=envelope(aNYppp,fun = Gest,nsim=20)
